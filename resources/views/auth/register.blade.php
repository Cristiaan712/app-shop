...
<div class="header header-filter" style="background-image: url('{{asset ('img/city.jpg') }}'); background-size: cover; background-position: topcenter;">
<div class="container">
    <div class="row">
...
<footer class="footer">
    <div class="container">
        ...
        <div class="copyright pull-right">
            &copy; 2018, Diseñado y creado <i class="fa fa-heart heart"></i> por <a href="http://www.creative-tim.com" target="_blank">Cristian</a>
        </div>
    </div>
</footer>
